!function(t, i, e) {
    ...
    s.prototype = {
        ...
        getTemplate: function() {
            ...
            n = '<table><tr><td><a href="#" data-action="incrementHour"><span class="' + this.icons.up + '"></span></a></td><td class="separator">&nbsp;</td><td><a href="#" data-action="incrementMinute"><span class="' + this.icons.up + '"></span></a></td>' + (this.showSeconds ? '<td class="separator">&nbsp;</td><td><a href="#" data-action="incrementSecond"><span class="' + this.icons.up + '"></span></a></td>' : "") + (this.showMeridian ? '<td class="separator">&nbsp;</td><td class="meridian-column"><a href="#" data-action="toggleMeridian"><span class="' + this.icons.up + '"></span></a></td>' : "") + "</tr><tr><td>" + i + '</td> <td class="separator">:</td><td>' + e + "</td> " + (this.showSeconds ? '<td class="separator">:</td><td>' + s + "</td>" : "") + (this.showMeridian ? '<td class="separator">&nbsp;</td><td>' + h + "</td>" : "") + '</tr><tr><td><a href="#" data-action="decrementHour"><span class="' + this.icons.down + '"></span></a></td><td class="separator"></td><td><a href="#" data-action="decrementMinute"><span class="' + this.icons.down + '"></span></a></td>' + (this.showSeconds ? '<td class="separator">&nbsp;</td><td><a href="#" data-action="decrementSecond"><span class="' + this.icons.down + '"></span></a></td>' : "") + (this.showMeridian ? '<td class="separator">&nbsp;</td><td><a href="#" data-action="toggleMeridian"><span class="' + this.icons.down + '"></span></a></td>' : "") + "</tr></table>",
            this.template) {
            case "modal":
        ...
        mousewheel: function(i) {
            if (!this.disableMousewheel) {
                ...
                s && (i.preventDefault(),
                t(this).scrollTop(s + t(this).scrollTop())),
                this.highlightedUnit) {
                case "minute":
        ...
        place: function() {
            if (!this.isInline) {
                ...
                "right" === this.orientation.x && (u -= e - l)) : (this.$widget.addClass("timepicker-orient-left"),
                d.left < 0 ? u -= d.left - h : d.left + e > n && (u = n - e - h));
        ...
        setDefaultTime: function(t) {
            if (this.$element.val())
                ...
                var i = new Date
                  ...
                  , h = i.getSeconds()
                  , n = "";
                0 !== h && (h = Math.ceil(i.getSeconds() / this.secondStep) * this.secondStep,
                60 === h && (s += 1,
                h = 0)),
                0 !== s && (s = Math.ceil(i.getMinutes() / this.minuteStep) * this.minuteStep,
                60 === s && (e += 1,
                s = 0)),
                this.showMeridian && (0 === e ? e = 24 : e >= 24 ? (e > 24 && (e -= 24),
                n = "") : n = ""),
                this.hour = e,
                this.minute = s,
                this.second = h,
        ...
        setTime: function(t, i) {
            ...
            if ("object" == typeof t && t.getMonth)
                ...
                if (e = (/a/i.test(t) ? 1 : 0) + (/p/i.test(t) ? 2 : 0),
                e > 2)
                    return void this.clear();
                if (s = t.replace(/[^0-9\:]/g, "").split(":"),
                h = s[0] ? s[0].toString() : s.toString(),
                this.explicitMode && h.length > 2 && h.length % 2 !== 0)
                    return void this.clear();
                n = s[1] ? s[1].toString() : "",
                o = s[2] ? s[2].toString() : "",
                h.length > 4 && (o = h.slice(-2),
                h = h.slice(0, -2)),
                h.length > 2 && (n = h.slice(-2),
                h = h.slice(0, -2)),
                n.length > 2 && (o = n.slice(-2),
                n = n.slice(0, -2)),
                h = parseInt(h, 10),
                n = parseInt(n, 10),
                o = parseInt(o, 10),
                ...
                o > 59 && (o = 59),
                n > 59 && (n = 59),
                h >= this.maxHours && (h = this.maxHours - 1),
                this.showMeridian ? (h > 24 && (e = 2,
                h -= 24),
                e || (e = 1),
                0 === h && (h = 24),
                a = 1 === e ? "" : "") : 24 > h && 2 === e ? h += 24 : h >= this.maxHours ? h = this.maxHours - 1 : (0 > h || 24 === h && 1 === e) && (h = 0)
            }
            this.hour = h,
            this.snapToStep ? (this.minute = this.changeToNearestStep(n, this.minuteStep),
    ...
    t(e).on("focus.timepicker.data-api click.timepicker.data-api", '[data-provide="timepicker"]', function(i) {
        var e = t(this);
        e.data("timepicker") || (i.preventDefault(),
        e.timepicker())
    })
