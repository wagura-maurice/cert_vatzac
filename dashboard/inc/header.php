...
<span class="username username-hide-on-mobile"> <?= ucwords($userClass->Insession('username')); ?> </span>
<img alt="<?= ucwords($userClass->Insession('username')); ?>" class="img-circle" src="../uploads/avatar/<?= ucwords($userClass->Insession('avatar')); ?>" /> </a>
...
<span class="title">Request Permit</span>
</a>
</li>
<li class="nav-item start ">
